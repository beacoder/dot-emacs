;;; cg-client.el --- call-graph client. -*- lexical-binding: t -*-
        ...
        (while (and (not cg--retrieval-done)
                    (or (not timeout-in-sec)
                        (< (float-time (time-subtract
                           ...
                           timeout-in-sec)))
          (cg--client-log "Spinning in waiting for response from remote.")
